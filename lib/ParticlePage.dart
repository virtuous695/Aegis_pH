...
import 'package:vertical_percent_indicator/vertical_percent_indicator.dart'; // Import VerticalBarIndicator package
...
class ParticlePage extends StatefulWidget {
  ...
  ParticlePage({Key? key, required this.deviceId}) : super(key: key);
...
class _ParticlePageState extends State<ParticlePage> {
          ...
          child: isLoading
              ...
              : Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    Text(
                      "Particle Value: ${particleCount != null ? particleCount!.toStringAsFixed(1) : '-'}",
                      style: TextStyle(
                        fontSize: 24,
                    ...
                    if (particleCount != null)
                      ElevatedButton(
                        onPressed: () {
                          ...
                          saveParticleCountToFirebase(
                              particleCount!, widget.deviceId);
  ...
  void saveParticleCountToFirebase(
